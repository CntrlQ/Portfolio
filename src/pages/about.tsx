...
export default function About() {
  return (
    <>
      <NextSeo
        title="About Noora Sajil | Frontend Developer"
        description="Learn more about Noora Sajil, a dedicated Frontend Developer with 2 years of experience. Discover the journey, skills, and passion that drive me to create innovative and user-friendly web solutions."
        canonical={`${siteMetadata.siteUrl}/about`}
        openGraph={{
          url: `${siteMetadata.siteUrl}/about`,
          title: "Learn About Noora Sajil - Frontend Developer",
          description:
            "Dive into the story of Noora Sajil, a Frontend Developer. Uncover the experiences, skills, and passion that fuel a commitment to delivering exceptional web solutions.",
          images: [
            {
              url: `${siteMetadata.siteUrl}${siteMetadata.twitterImage}`,
              alt: "Noora Sajil - Portfolio Image",
            },
          ],
        ...
        <div className="sm:1/2 mt-10 w-full lg:w-1/2">
          <AnimatePresence>
            <FadeUp key="title-greeting" duration={0.6}>
              <h1 className="bg-gradient-to-r from-pink-500 to-tera-500 bg-clip-text text-6xl font-bold text-transparent dark:from-pink-200 dark:to-pink-500 sm:text-7xl md:text-6xl lg:text-5xl xl:text-7xl">
                Hi, I&apos;m Noora Sajil
              </h1>
            </FadeUp>
            ...
            >
              ...
              <span className="text-lg font-medium">Thrissur, India</span>
            </FadeRight>
          </AnimatePresence>
        </div>
      </div>
