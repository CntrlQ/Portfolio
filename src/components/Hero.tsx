        ...
        <div className="mx-auto max-w-7xl">
          <AnimatePresence>
            <FadeUp key="title-main" duration={0.6}>
              <h1 className="bg-gradient-to-r from-pink-500 to-tera-500 bg-clip-text py-2 text-5xl font-bold text-transparent dark:from-pink-200 dark:to-pink-500 sm:text-6xl md:text-7xl xl:text-8xl">
                Noora Sajil
              </h1>
            ...
            <FadeUp key="description" duration={0.6} delay={0.2}>
              <div className="mt-8 max-w-3xl text-base font-semibold text-zinc-900 dark:text-zinc-200 sm:text-base md:text-2xl">
                <span className="text-xl text-pink-600 dark:text-pink-300 sm:text-3xl">
                  Hi
                </span>
                , I&apos;m
