    ...
    >
      <span
        className={classNames(
          ...
          props.activeProject === props.data.index
            ...
            : "text-pink-600/30 dark:text-pink-600/50",
        )}
      >
        {props.data.index + 1}.
      </span>
      ...
      <div className="flex flex-col gap-2">
        <Link href={props.data.href} className="relative max-w-max">
          ...
          <span className="hover:-underline-offset-1 text-3xl font-semibold text-pink-600 transition-colors duration-300 hover:underline dark:text-pink-400 sm:text-4xl md:text-5xl lg:hidden">
            {props.data.title}
          </span>
          <span
            className={classNames(
              "absolute -bottom-1 left-0 hidden h-1 origin-left rounded-lg bg-pink-600 transition-[width] duration-300 group-hover:w-full dark:bg-pink-400 lg:block",
