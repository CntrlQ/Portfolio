...
export default function ProjectCard(props: ProjectCardProps) {
  return (
    <motion.div
      ...
      className="w-full overflow-hidden rounded-lg border border-zinc-500/30 bg-white transition-shadow duration-150 hover:shadow-md dark:border-pink-200/10 dark:bg-zinc-800 dark:hover:shadow-sm dark:hover:shadow-pink-200/50"
    >
      ...
      <div className="p-3 sm:p-4">
        ...
        <div className="mt-6 flex items-center justify-end gap-6">
          {props.sourceCodeHref && (
            ...
            >
              <FigmaIcon className="h-5 w-5" /> Source code
            </a>
          )}
