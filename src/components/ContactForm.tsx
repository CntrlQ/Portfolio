    ...
    <>
      {showToast && (
        <Toast
          ...
          className={classNames(
            "fixed right-4 top-6 z-[9999] rounded-lg bg-pink-500 px-4 py-2 font-semibold text-white shadow-xl",
            showToast.type === "PASS"
              ? "bg-pink-500"
      ...
      {isBtnVisible && !isOpenModal && (
        <button
          ...
          type="button"
          className="fixed bottom-4 right-4 flex h-12 w-12 items-center justify-center rounded-full bg-pink-600 p-2 text-white transition-colors duration-150 hover:bg-pink-500 sm:bottom-8 sm:right-8 sm:h-14 sm:w-14 sm:p-3 lg:h-16 lg:w-16"
      ...
      <div className="text-center">
        <button
          ref={refSendBtn}
          className="inline-flex items-center gap-2 rounded-md bg-zinc-100 px-3 py-2 text-pink-600 transition-transform duration-150 focus-within:scale-[1.05] hover:scale-[1.05] hover:bg-white"
          onClick={() => setIsOpenModal(true)}
        >
      ...
      <Transition show={isOpenModal} as={Fragment}>
        ...
        >
          ...
          <div className="fixed inset-0 z-[9999] flex items-center justify-center">
            ...
            >
              <Dialog.Panel className="absolute m-4 w-[95%] max-w-xl overflow-y-auto rounded-2xl border-2 border-pink-100/20 bg-pink-600 px-6 py-8 shadow-lg shadow-pink-200/10 dark:bg-pink-700 md:px-10 md:py-16">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    className="flex h-10 w-10 items-center justify-center rounded-full border-2 border-pink-600 bg-pink-50 p-2 text-sm text-pink-600 transition-transform hover:scale-[1.05] hover:bg-pink-100"
                  ...
                  >
                    <svg
                      ...
                      height="100%"
                      viewBox="0 0 23 23"
                      className="ml-[1px] mt-1 stroke-tera-500 dark:stroke-pink-600"
                    >
                      <path
                        fill="transparent"
                        strokeWidth="3"
                  ...
                  {({ isValid }) => (
                    <Form className="mt-6 flex flex-col gap-3">
                            ...
                            {({
                              ...
                              <>
                                <input
                                  ...
                                  type="text"
                                  placeholder="Email"
                                  className="w-full rounded-lg border-none bg-pink-50 font-semibold text-pink-800 placeholder:font-normal placeholder:text-zinc-400 focus-within:border-2 focus-within:border-pink-600 focus-within:ring-pink-600"
                                />
                      ...
                      <button
                        aria-label="open send mail modal"
                        type="submit"
                        className="mt-4 w-full rounded-full bg-pink-50 px-4 py-3 text-center text-lg font-semibold text-pink-900 transition-colors duration-150 hover:bg-pink-100"
                        disabled={!isValid}
                      >
                        {isSendingMail ? (
