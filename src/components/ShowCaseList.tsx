    ...
    <figure className="absolute left-0 stroke-zinc-900">
      <svg width="75" height="75" viewBox="0 0 100 100">
        <circle
          ...
          cy="27"
          r="20"
          className="fill-none stroke-pink-600 stroke-1"
        />
        <motion.circle
          style={{
        ...
        <circle
          ...
          cy="27"
          r="10"
          className="fill-pink-600 stroke-1 dark:fill-pink-400"
        />
      </svg>
    </figure>
  );
...
export default function ShowCaseList(props: TShowCaseList) {
  ...
  return (
    <div className="mx-auto my-40 max-w-7xl px-6 sm:px-14 md:my-60 md:px-20">
      <h2 className="md:mb-30 mb-16 w-full bg-gradient-to-r from-pink-400 to-tera-500 bg-clip-text text-center text-3xl font-bold text-transparent dark:from-pink-200 dark:to-pink-500 xs:text-4xl sm:text-6xl md:text-8xl">
        {props.title}
      </h2>
      <div ref={ref} className="relative w-full md:mx-auto md:w-[80%]">
        <motion.div
          style={{ scaleY: scrollYProgress }}
          className="absolute left-9 top-5 h-full w-[5px] origin-top rounded-lg bg-pink-600 dark:bg-pink-400"
        ></motion.div>
