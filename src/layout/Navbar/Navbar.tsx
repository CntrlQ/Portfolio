  ...
  return (
    <header className="sticky top-0 z-50 mt-2 px-6 py-8 sm:mt-8 sm:px-14 md:px-20">
      <div className="mx-auto flex items-center justify-between lg:max-w-7xl">
        ...
        <nav className="hidden items-center gap-2 rounded-full px-2 py-2 shadow-md ring-1 ring-zinc-200 backdrop-blur-md dark:ring-pink-600/50 md:flex">
                  ...
                  >
                    {_link.href === pathName && (
                      <motion.span
                        ...
                        className="absolute inset-0 -z-10 rounded-full bg-tera-500 group-hover:bg-tera-500/80 dark:bg-pink-400 dark:group-hover:bg-pink-500"
                      ></motion.span>
                    )}
                    {_link.title}
                  </Link>
      ...
      <Transition show={isModalOpen} as={Fragment}>
        <Dialog as="div" className="z-50" onClose={setIsModalOpen}>
          <div className="fixed inset-0 flex items-center justify-center">
            ...
            >
              <Dialog.Panel className="pointer-events-none absolute flex min-h-[85%] w-full flex-col items-center justify-center overflow-y-auto rounded-b-2xl border-2 border-pink-100/20 border-pink-600 bg-zinc-100 px-6 py-8 text-pink-600 shadow-lg shadow-pink-200/10 dark:bg-pink-700 dark:text-zinc-100 md:px-10 md:py-16">
                    ...
                    >
                      <span
                        className={classNames(
                          ...
                          "absolute -bottom-1 left-0 h-1 rounded-lg bg-pink-600 transition-[width] duration-300 group-hover:w-full dark:bg-zinc-100",
                        )}
                      ></span>
                      {link.title}
                    </button>
                ...
                <div className="absolute bottom-0 py-6">©2023 Noora Sajil</div>
              </Dialog.Panel>
            </Transition.Child>
          </div>
        </Dialog>
